...
import com.yep.odar.Activity.Main_Base;
import com.yep.odar.Activity.Product;
import com.yep.odar.Activity.Search;
import com.yep.odar.Activity.Setting;
import com.yep.odar.R;

/**
 * Created by yep on 2017. 9. 24..
 */

public class Base_Avtivity extends AppCompatActivity {
    ...
    public void setActionBar(int type, String title) {
        if (type == NO_ACTION_BAR) {
            ...
            actionbar_right = (ImageView) customView.findViewById(R.id.actionbar_right);
            actionbar_right_extra = (ImageView) customView.findViewById(R.id.actionbar_right_extra);
            actionbar_search = (RelativeLayout) customView.findViewById(R.id.actionbar_search);
            actionbar_search_et = (EditText) customView.findViewById(R.id.actionbar_search_et);
            actionbar_search_icon = (ImageView) customView.findViewById(R.id.actionbar_search_icon);
            ...
            if (type == CUSTOM_ACTION_BAR_BACK) {
                ...
                actionbar_right.setBackground(getResources().getDrawable(R.drawable.btn_x_white));
                actionbar_right_extra.setVisibility(View.INVISIBLE);
                ...
                actionbar_right.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(getApplicationContext(), Main_Base.class);
                ...
                actionbar_back.setVisibility(View.INVISIBLE);
                actionbar_right.setVisibility(View.VISIBLE);
                actionbar_right.setBackground(getResources().getDrawable(R.drawable.actionbar_setting));
                actionbar_right_extra.setVisibility(View.INVISIBLE);
                actionbar_search.setVisibility(View.INVISIBLE);
                actionbar_search_et.setVisibility(View.INVISIBLE);
                actionbar_search_icon.setVisibility(View.INVISIBLE);
                ...
                actionbar_back.setVisibility(View.INVISIBLE);
                actionbar_right.setVisibility(View.VISIBLE);
                actionbar_right.setBackground(getResources().getDrawable(R.drawable.cart));
                actionbar_right_extra.setVisibility(View.VISIBLE);
                actionbar_right_extra.setBackground(getResources().getDrawable(R.drawable.actionbar_search));
                actionbar_search.setVisibility(View.GONE);
                actionbar_search_et.setVisibility(View.INVISIBLE);
                actionbar_search_icon.setVisibility(View.INVISIBLE);
                actionbar_title.setVisibility(View.VISIBLE);
                ...
                actionbar_right_extra.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
